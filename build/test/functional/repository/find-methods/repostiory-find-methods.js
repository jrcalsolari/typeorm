...
describe("repository > find methods", () => {
    ...
    describe("exists", function () {
        it("should return a True when no criteria given", () => Promise.all(connections.map(async (connection) => {
            const postRepository = connection.getRepository(Post_1.Post);
            for (let i = 0; i < 100; i++) {
                const post = new Post_1.Post();
                post.id = i;
        ...
        it("should return True when matches the given criteria", () => Promise.all(connections.map(async (connection) => {
            const postRepository = connection.getRepository(Post_1.Post);
            for (let i = 1; i <= 100; i++) {
                const post = new Post_1.Post();
                post.id = i;
        ...
        it("should return True when matches the given multiple criteria", () => Promise.all(connections.map(async (connection) => {
            const postRepository = connection.getRepository(Post_1.Post);
            for (let i = 1; i <= 100; i++) {
                const post = new Post_1.Post();
                post.id = i;
        ...
        it("should return True when matches the given find options", () => Promise.all(connections.map(async (connection) => {
            const postRepository = connection.getRepository(Post_1.Post);
            for (let i = 1; i <= 100; i++) {
                const post = new Post_1.Post();
                post.id = i;
        ...
        it("should return True when matches both criteria and find options", () => Promise.all(connections.map(async (connection) => {
            const postRepository = connection.getRepository(Post_1.Post);
            for (let i = 1; i <= 100; i++) {
                const post = new Post_1.Post();
                post.id = i;
    ...
    describe("findOneOrFail", function () {
        ...
        it("should return entity by a given id and find options", () => Promise.all(connections.map(async (connection) => {
            ...
            try {
                ...
                (0, chai_1.expect)(err).to.be.an.instanceOf(EntityNotFoundError_1.EntityNotFoundError);
                (0, chai_1.expect)(err).to.have.property("entityClass", "User");
                (0, chai_1.expect)(err).to.have.property("criteria", options);
            }
        })));
