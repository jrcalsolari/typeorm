...
describe("schema builder > change column", () => {
    ...
    it("should correctly change column comment", () => Promise.all(connections.map(async (connection) => {
        ...
        (0, chai_1.expect)(persistedTagColumnA.comment).to.be.equal(undefined, connection.name);
        (0, chai_1.expect)(persistedTagColumnA.isNullable).to.be.equal(true, connection.name);
        ...
        (0, chai_1.expect)(persistedTagColumnB.comment).to.be.equal("Tag");
        (0, chai_1.expect)(persistedTagColumnB.isNullable).to.be.false;
