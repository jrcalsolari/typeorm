...
describe("relations > eager relations > lazy nested eager relations", () => {
    ...
    it("should load all eager relations nested inside a lazy relation", () => Promise.all(connections.map(async (connection) => {
        ...
        (0, chai_1.expect)(loadedPost?.categories1).to.have.deep.members([
            {
                id: 1,
        ...
        (0, chai_1.expect)(loadedPost?.categories2).to.have.deep.members([
            {
                id: 3,
        ...
        (0, chai_1.expect)(loadedPost?.author).to.deep.equal({
            id: 1,
            firstName: "Timber",
            lastName: "Saw",
            profile: {
        ...
        (0, chai_1.expect)(loadedPost?.editors).to.have.deep.members([
            {
                id: 1,
                user: {
                    id: 1,
