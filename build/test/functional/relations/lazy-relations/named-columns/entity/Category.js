...
tslib_1.__decorate([
    (0, ManyToMany_1.ManyToMany)((type) => Post_1.Post, (post) => post.categoriesNamedColumn),
    tslib_1.__metadata("design:type", Promise)
], Category.prototype, "postsNamedColumn", void 0);
tslib_1.__decorate([
    (0, OneToMany_1.OneToMany)((type) => Post_1.Post, (post) => post.categoryNamedColumn),
    tslib_1.__metadata("design:type", Promise)
], Category.prototype, "onePostsNamedColumn", void 0);
tslib_1.__decorate([
    (0, OneToOne_1.OneToOne)((type) => Post_1.Post, (post) => post.oneCategoryNamedColumn),
    tslib_1.__metadata("design:type", Promise)
