...
tslib_1.__decorate([
    (0, ManyToMany_1.ManyToMany)((type) => Category_1.Category, (category) => category.postsNamedTable),
    (0, JoinTable_1.JoinTable)(),
    tslib_1.__metadata("design:type", Promise)
], Post.prototype, "categoriesNamedTable", void 0);
tslib_1.__decorate([
    (0, ManyToOne_1.ManyToOne)((type) => Category_1.Category, (category) => category.onePostsNamedTable),
    (0, JoinColumn_1.JoinColumn)(),
    tslib_1.__metadata("design:type", Promise)
], Post.prototype, "categoryNamedTable", void 0);
tslib_1.__decorate([
    (0, OneToOne_1.OneToOne)((type) => Category_1.Category, (category) => category.onePostNamedTable),
    (0, JoinColumn_1.JoinColumn)(),
    tslib_1.__metadata("design:type", Promise)
], Post.prototype, "oneCategoryNamedTable", void 0);
exports.Post = Post = tslib_1.__decorate([
    (0, Entity_1.Entity)("s_post", {
        orderBy: {
            title: "ASC",
            id: "DESC",
        },
