...
const PostDetails_1 = require("../../sample/sample2-one-to-one/entity/PostDetails");
const Post_1 = require("../../sample/sample2-one-to-one/entity/Post");
const PostCategory_1 = require("../../sample/sample2-one-to-one/entity/PostCategory");
const PostAuthor_1 = require("../../sample/sample2-one-to-one/entity/PostAuthor");
const PostMetadata_1 = require("../../sample/sample2-one-to-one/entity/PostMetadata");
const PostImage_1 = require("../../sample/sample2-one-to-one/entity/PostImage");
const PostInformation_1 = require("../../sample/sample2-one-to-one/entity/PostInformation");
    ...
    describe("cascade remove should be executed when cascadeRemove option is set", function () {
        ...
        it("should remove a relation entity successfully when removed", function () {
            ...
            return postMetadataRepository
                ...
                .then((reloadedPost) => {
                (0, chai_1.expect)(reloadedPost.metadata).to.not.exist;
            });
        });
    });
});
