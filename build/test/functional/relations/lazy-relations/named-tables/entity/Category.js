...
tslib_1.__decorate([
    (0, ManyToMany_1.ManyToMany)((type) => Post_1.Post, (post) => post.categoriesNamedTable),
    tslib_1.__metadata("design:type", Promise)
], Category.prototype, "postsNamedTable", void 0);
tslib_1.__decorate([
    (0, OneToMany_1.OneToMany)((type) => Post_1.Post, (post) => post.categoryNamedTable),
    tslib_1.__metadata("design:type", Promise)
], Category.prototype, "onePostsNamedTable", void 0);
tslib_1.__decorate([
    (0, OneToOne_1.OneToOne)((type) => Post_1.Post, (post) => post.oneCategoryNamedTable),
    tslib_1.__metadata("design:type", Promise)
], Category.prototype, "onePostNamedTable", void 0);
exports.Category = Category = tslib_1.__decorate([
    (0, Entity_1.Entity)("s_category", {
        orderBy: {
            id: "ASC",
        },
    })
