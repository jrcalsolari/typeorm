...
const Example_1 = require("../query-data/entity/Example");
...
describe("entity subscriber > transaction flow", () => {
    ...
    let afterInsert = sinon_1.default.spy();
    ...
    it("query data in subscribers", async () => {
        ...
        for (let connection of connections) {
            ...
            await queryRunner.commitTransaction();
            (0, chai_1.expect)(afterInsertQueryRunnerData).to.eql(data);
            afterInsertQueryRunnerData = undefined;
            await queryRunner.release();
        }
    });
